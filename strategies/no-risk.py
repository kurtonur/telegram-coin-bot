...
async def main():
    ...
    try:
        await send_message(text=startup_message, chat_types=["signal","log"])
    ...
    while True:
        ...
        for coin in COINS:
            try:
                ...
                df = get_candles(symbol=coin, granularity="15min", limit=300)
                ...
                side, details = calculate_signal(df=df)
